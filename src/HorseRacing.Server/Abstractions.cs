...
public class OutstandingStake
{
    ...
    /// <summary>What was taken for a race and has not been returned.</summary>
...
/// <summary>
/// Records what the table owes the player while a race is in flight.
///
...
/// debit and the credit of a single race, and what is owed in that window is
